...
<?php //dd($arResult['ITEMS'][0]['PROPERTIES'])?>
<?php if ($arResult['SECTION_BY_ID'] and count($arResult['SECTION_BY_ID']) > 1): ?>
    ...
    <div class="catalog-hero__thumbs">
        <?php foreach ($arResult['SECTION_BY_ID'] as $arSection): ?>
            ...
            <a class="catalog-hero__thumbs-item <?= $arSection['IS_ACTIVE'] ? 'active' : '' ?> btn-hover_parent"
                    ...
                    <div class="catalog-card__bot">
                        ...
                        <div class="catalog-card__plugs">
                            <div class="catalog-card__plug">
                                ...
                                <div class="catalog-card__plug-info" text="description text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                         viewbox="0 0 24 24"
                                         fill="none">
                            ...
                            <div class="catalog-card__plug">
                                ...
                                <div class="catalog-card__plug-text"><?= $arItem['PROPERTIES']['CNT_BOX']['VALUE'] ?>
                                    шт
                                </div>
                            ...
                            <div class="catalog-card__plug">
                                ...
                                <div class="catalog-card__plug-text"><?= $arItem['PROPERTIES']['CNT_PALLETE']['VALUE'] ?> шт</div>
                                <div class="catalog-card__plug-info"
                                     data-text="<?= $arItem['PROPERTIES']['CNT_PALLETE']['HINT'] ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                         viewbox="0 0 24 24"
                                         fill="none">
                                        <rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
