...
<?php if (is_array($arResult['SECTION']['PATH'])) {
    $APPLICATION->SetTitle(end($arResult['SECTION']['PATH'])['NAME']);
} ?>
<form class="popup-filters mobile" data-popup-wrapper="catalog-filters" data-overlay-on>
    ...
    <div class="popup-filters__top">
        ...
        <div class="popup-filters__tops">
            <label class="catalog-hero__tops" for="top">
                <input class="catalog-hero__tops-input" type="checkbox" name="top" id="top" value="top" <?= $_GET['top'] == 'top' ? 'checked' : '' ?>>
...
<section class="catalog-hero top-section container">
    ...
    <div class="catalog-hero__top">
        <h1 class="catalog-hero__title"><?php $APPLICATION->ShowTitle(); ?></h1>
    ...
    <form class="catalog-hero__activity" data-aos="fade-up">
        ...
        <div class="catalog-hero__selects">
            ...
            <?php if ($arResult['PROPS_FILTER_UI']['BRAND']) : ?>
                <div class="catalog-hero__select desktop">
                    <div class="select-wrapper">
                        <div class="select">
                            <select type="data-filter-select" class="select__select" style="width: 100%" data-select-placeholder="Бренд" name="brand">
                                <option value="" selected="selected" disabled="disabled"></option>

                                <?php foreach ($arResult['PROPS_FILTER_UI']['BRAND'] as $arItem) : ?>
                                    <option value=<?= $arItem['ID']; ?> <?= $_GET['brand'] == $arItem['ID'] ? 'selected="selected"' : '' ?>> <?= $arItem['NAME'] ?> </option>
                                <?php endforeach; ?>
            ...
            <?php if ($arResult['PROPS_FILTER_UI']['FAT']) : ?>
                <div class="catalog-hero__select desktop">
                    <div class="select-wrapper">
                        <div class="select">
                            <select type="data-filter-select" class="select__select" style="width: 100%" data-select-placeholder="Жирность" name="fat">
                                <option value="" selected="selected" disabled="disabled"></option>

                                <?php foreach ($arResult['PROPS_FILTER_UI']['FAT'] as $arItem) : ?>
                                    <option value=<?= $arItem ?> <?= $_GET['fat'] == $arItem ? 'selected="selected"' : '' ?>><?= $arItem ?></option>
                                <?php endforeach; ?>
            ...
            <div class="catalog-hero__select">
                <div class="select-wrapper">
                    <div class="select cstm-arrows">
                        <select type="data-filter-select" class="select__select" style="width: 100%" data-select-placeholder="Сначала новинки" name="sort">
                            <option value="" selected="selected" disabled="disabled"></option>
                            <option value="new" <?= $_GET['sort'] == 'new' ? 'selected="selected"' : '' ?>>Сначала новинки</option>
                            <option value="popular" <?= $_GET['sort'] == 'popular' ? 'selected="selected"' : '' ?>>Сначала популярные</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="catalog-hero__reset desktop">
            ...
            <div class="catalog-hero__reset-text" id="reset__my">Сбросить</div>
        </div>
        <input type="submit">
    </form>
</section>
                    ...
                    <div class="catalog-card__inner">
                        ...
                        <div class="catalog-card__bot">
                            ...
                            <div class="catalog-card__plugs">
                                ...
                                <?php foreach ($arItem['PROPERTIES']['PACK_PROPS'] as $property) : ?>
                                    <div class="catalog-card__plug">

                                        <?php if ($property['CODE'] === 'WEIGHT') : ?>
                                        ...
                                        <?php if ($property['CODE'] === 'CNT_PALLETE') : ?>
                                            <div class="catalog-card__plug-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                        ...
                                        <div class="catalog-card__plug-text"><?= $property['VALUE'] ?> г</div>

                                        <?php if ($property['DESCR']) : ?>
                                            <div class="catalog-card__plug-info" data-text="<?= $property['DESCR'] ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
...
<?php else : ?>
    <div class="search-results__empty catalog">
        <p class="search-results__empty-title">Под эти фильтры нет подходящих продуктов :(</p>
