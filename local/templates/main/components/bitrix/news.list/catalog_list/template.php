        ...
        <div class="breadcrumbs">
            <div class="breadcrumbs-wrapper">
                <div class="breadcrumbs-wrapper__row">
                    <?php $chainCnt = count($arResult['NAV_CHAIN']);
                    foreach ($arResult['NAV_CHAIN'] as $index => $section) : ?>
                        <?php if ($index < $chainCnt - 1) : ?>
                            <a class="breadcrumbs__item" href=<?= $section['URL'] ?>><?= $section['NAME'] ?></a>
                        ...
                        <?php else : ?>
                            <div class="breadcrumbs__current active"><?= $section['NAME'] ?></div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
            </div>
                    ...
                    <div class="catalog-card__inner">
                        ...
                        <div class="catalog-card__bot">
                            <div class="catalog-card__text">
                                <?= 'Shows:'.$arItem['SHOW_COUNTER'].' Active:'.$arItem['ACTIVE_FROM'].' '.$arItem['PREVIEW_TEXT'] ?>
                            </div>
