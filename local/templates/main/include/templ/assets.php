...
$asset->addString('<script defer="defer" src="' . SITE_TEMPLATE_PATH . '/assets/vendor.js"></script>');
$asset->addString('<script defer="defer" src="' . SITE_TEMPLATE_PATH . '/assets/app.js"></script>');
