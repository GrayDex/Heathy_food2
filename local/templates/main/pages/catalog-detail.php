...
<section class="catalog-detail top-section container">
    ...
    <div class="catalog-detail__inner">
                            ...
                            <div class="swiper-slide">
                                <div class="catalog-detail__thumb-img">
                                    <picture class="picture">
                                        ...
                                        <img class="picture__img" src="assets/images/catalog-detail1.png">
                                    </picture>
                                </div>
                            </div>
                            <div class="swiper-slide">
        ...
        <div class="catalog-detail__col info" data-aos="fade-up">
            ...
            <span class="catalog-detail__brandmark">Здоровые Продукты</span>
            ...
            <div class="catalog-detail__thumbs" data-aos="fade-up">
                ...
                <div class="catalog-detail__thumbs-row">
                    <div class="catalog-hero__recomendations details"><a class="catalog-hero__rec blue btn-hover_parent"
                                                                         href="./assets/images/fabricat.pdf" download>
                            ...
                            <div class="catalog-hero__rec-circle">
                                <div class="button button-arrow_right btn-hover_parent">
                                    ...
                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8 10.8696L8 8.7549C8 6.47285 10.6192 5.18375 12.4275 6.57579L16.1488 9.44043C17.5788 10.5413 17.5788 12.6978 16.1488 13.7987L12.4275 16.6633C10.6192 18.0554 8 16.7662 8 14.4842L8 12.3696L8 10.8696Z"
                                              fill="#0068FF"></path>
                                    </svg>
                                </div>
                            </div>
            ...
            <div class="catalog-detail__accordeons accordion-container" data-aos="fade-up">
                ...
                <div class="ac ac-vacancies ac-catalog">
                    ...
                    <div class="ac-panel ac-catalog__bot">
                        <div class="ac-catalog__text">Вода питьевая, сливки пастеризованные, молоко цельное сгущенное с
                            сахаром, сахар, вафельный стаканчик, сухое цельное молоко, глазурь «Шоколадная» с
                            растительным жиром, сливочное масло, ядра арахиса обжаренные (дробленые), сухое обезжиренное
                            молоко, патока, комплексная пищевая добавка, ароматизатор ванилин.<br>Массовая доля жира 12
                            %.
                        </div>
                    </div>
                </div>
                    ...
                    <form class="partners-requisites__form" data-form="catalog-detail">
                        <div class="partners-requisites__form-top">
                            ...
                            <div class="input-wrapper" data-input-parent="">
                                ...
                                <input class="input" data-input="" required type="tel" placeholder="Телефон"
                                       data-mask-phone="">
                            </div>
                            <div class="input-wrapper" data-input-parent="">
                        ...
                        <div class="partners-requisites__form-area">
                            <div class="input-wrapper input-wrapper_textarea" data-input-parent="">
                                ...
                                <textarea class="textarea" data-input="" type="text"
                                          placeholder="Комментраий к заявке"></textarea>
                            </div>
                        </div>
            ...
            <a class="catalog-detail__rect btn-hover_parent" href="#">
                    ...
                    <div class="catalog-detail__rect-box">
                        <div class="catalog-detail__rect-img">
                            <picture class="picture">
                                ...
                                <img class="picture__img" src="assets/images/catalog-detail-next1.png">
                            </picture>
                        </div>
                    </div>
                </div>
